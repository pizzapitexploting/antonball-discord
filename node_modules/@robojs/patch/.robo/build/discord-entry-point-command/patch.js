...
export const DiscordEntryPointCommand = {
    patch
};
/**
 ...
 */ async function patch() {
    ...
    const commandsResponse = await request('/commands', {
        clientId,
        token
    });
    ...
    const commandResponse = await request.post('/commands', {
        body,
        clientId,
        token
    });
...
request.post = (path, options)=>request(path, {
        ...options,
        method: 'POST'
    });
