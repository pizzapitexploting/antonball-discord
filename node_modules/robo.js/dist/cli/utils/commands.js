import { ContextMenuCommandBuilder, SlashCommandBuilder, REST, Routes } from 'discord.js';
...
function buildContextCommands(dev, contextCommands, type) {
  ...
  return Object.entries(contextCommands).map(([key, entry]) => {
    ...
    const commandBuilder = new ContextMenuCommandBuilder().setName(key).setNameLocalizations(entry.nameLocalizations || {}).setType(type === "message" ? 3 : 2);
